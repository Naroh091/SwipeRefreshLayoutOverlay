...
package es.oneoctopus.swiperefreshlayoutoverlay;
 ...
 */
public class SwipeRefreshLayoutOverlay extends ViewGroup {
    private static final String LOG_TAG = SwipeRefreshLayoutOverlay.class.getSimpleName();
    ...
    // SwipeRefreshLayoutOverlay Margin
     ...
     * @param context
     */
    public SwipeRefreshLayoutOverlay(Context context) {
        this(context, null);
    }
